...
describe "Brock::StatsCalculator" do
  ...
  let(:valid_stats) { { :games => 157, :at_bats => 624, :runs => 96, :hits => 207, :doubles => 32, :triples => 5, :home_runs => 28, :rbi => 99, :stolen_bases => 12, :caught_stealing => 7, :walks => 32, :strikeouts => 91, :gidp => 16, :hbp => 6, :sh => 0, :sf => 6, :iw => 7 } }
  ...
  let(:zero_stats) { { :games => 0, :at_bats => 0, :runs => 0, :hits => 0, :doubles => 0, :triples => 0, :home_runs => 0, :rbi => 0, :stolen_bases => 0, :caught_stealing => 0, :walks => 0, :strikeouts => 0, :gidp => 0, :hbp => 0, :sh => 0, :sf => 0, :iw => 0 } }

  let(:minimal_stats) { { :games => 1, :at_bats => 1, :runs => 0, :hits => 0, :doubles => 0, :triples => 0, :home_runs => 0, :rbi => 0, :stolen_bases => 0, :caught_stealing => 0, :walks => 0, :strikeouts => 0, :gidp => 0, :hbp => 0, :sh => 0, :sf => 0, :iw => 0 } }
