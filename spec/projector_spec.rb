...
describe Brock::Projector do
  describe "#project_career" do
    ...
    describe "games played projection" do
        let(:stats) { { 28 => { :year => 1998, :proj_games => 157, :games => 157, :at_bats => 624, :runs => 96, :rc => 88, :hits => 207, :doubles => 32, :triples => 5, :home_runs => 28, :rbi => 99, :sb => 12, :cs => 7, :walks => 32, :strike_outs => 91, :gidp => 16, :hbp => 6, :sh => 0, :sf => 6, :iw => 7, :playtime => { :regular => true, :bench => true, :play_factor => 1.00 } },
